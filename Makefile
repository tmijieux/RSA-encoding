#############################################################################
# Makefile for building: rsa-encoding
# Generated by qmake (2.01a) (Qt 4.6.2) on: lun. févr. 14 19:26:52 2011
# Project:  rsa-encoding.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile rsa-encoding.pro
#############################################################################
...
SOURCES       = FenRsa-encoding.cpp \
		main.cpp moc_FenRsa-encoding.cpp
OBJECTS       = FenRsa-encoding.o \
		main.o \
		moc_FenRsa-encoding.o
...
Makefile: rsa-encoding.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile rsa-encoding.pro
...
moc_FenRsa-encoding.cpp: FenRsa-encoding.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) FenRsa-encoding.h -o moc_FenRsa-encoding.cpp
...
moc_FenRsa-encoding.o: moc_FenRsa-encoding.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_FenRsa-encoding.o moc_FenRsa-encoding.cpp
